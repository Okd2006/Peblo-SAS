  ...
  return (
    <div className="min-h-screen flex" style={{ background: "var(--background)" }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] p-10 relative overflow-hidden"
        ...
        <div className="relative z-10 space-y-6">
          <div>
            ...
            <p className="text-violet-200 mt-3 text-sm leading-relaxed">
              Join thousands of professionals using Peblo Notes to capture ideas, summarize meetings, and stay organized.
            </p>
          </div>
        ...
        <p className="relative z-10 text-xs text-violet-300">Peblo — Friendly Innovation</p>
      </div>

      {/* Right form */}
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          <div className="lg:hidden mb-8"><PebloLogo size={32} /></div>
          ...
          <p className="text-center text-sm mt-6" style={{ color: "var(--text-secondary)" }}>
            ...
            <Link href="/login" className="font-medium underline underline-offset-2 transition-colors hover:opacity-70"
